export type CopyTextMethod = "clipboard" | "legacy";

export async function copyText(value: string): Promise<CopyTextMethod> {
  ...
  throw new Error(
    "Copy was blocked by this browser. Open the supplier link and copy its address from the browser."
  );
}
