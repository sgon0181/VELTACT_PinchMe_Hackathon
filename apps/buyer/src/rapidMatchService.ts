...
const baseMatches: SupplierMatch[] = [
  {
    id: "match-kinetic",
...
const invitations: SupplierInvitation[] = [
  {
    id: "invite-kinetic",
    needProfileId: "need-demo",
    supplierId: "sup-kinetic-controls",
...
const responses: SupplierResponse[] = [
  {
    ...
    relevantExperience:
      "Recovered three failed Siemens PLC-controlled conveyor cells for food and beverage sites this quarter.",
  ...
  },
  {
    ...
    relevantExperience:
      "Commissioned similar packaging conveyors and servo drives for two NSW manufacturing plants.",
...
function rankMatches(priority: PrioritySignal): SupplierMatchView[] {
  const weights: Record<PrioritySignal, Record<string, number>> = {
  ...
  const reasons: Record<PrioritySignal, Record<string, string>> = {
    speed: {
