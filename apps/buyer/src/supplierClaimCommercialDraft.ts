export type SupplierCommercialDraft = {
  source: "blank" | "demo_fixture";
  availability: string;
  indicativePriceAud: string;
...
export const demoCommercialFillAction =
  "fill-demo-commercial-response" as const;

export function emptySupplierCommercialDraft(): SupplierCommercialDraft {
  return {
    source: "blank",
    availability: "",
    indicativePriceAud: "",
...
export function demoCommercialDraftForAction(
  action: string | undefined,
  demoControlsAvailable: boolean,
  robotics: boolean
): SupplierCommercialDraft | undefined {
  if (
    action !== demoCommercialFillAction ||
