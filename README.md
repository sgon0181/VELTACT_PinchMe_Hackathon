...
Build the buyer frontend, then open its public files with a local static server:

```bash
npm run build -w apps/buyer
npx serve apps/buyer/public -l 5173
```

- Marketing entry: `http://localhost:5173/landing.html`
- Buyer RapidMatch demo: `http://localhost:5173/index.html`
