...
- Primary buyer workspace: `http://localhost:4000/v2.html`
- Classic RapidMatch demo: `http://localhost:4000/index.html`
...
open the generated buyer workspace first, then open its private supplier invitation
when the buyer reaches Connect. The launcher resets V2 demo state and is unavailable
in production.
